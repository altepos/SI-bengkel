                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url('barang') ?>"><i class="fa fa-list-ol"></i> <span>List Barang</span></a></li>
                                <li><a href="<?php echo base_url('merk') ?>"><i class="fa fa-tags"></i> Merk Barang</a></li>
                                <li><a href="<?php echo base_url('kategori') ?>"><i class="fa fa-flag"></i> Kategori Barang</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
